                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group row {{ $errors->has('no_rm') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="no_rm" class="form-control" placeholder="No Rekam Medis">
                                @if ($errors->has('no_rm'))
                        ...
                        <div class="form-group row {{ $errors->has('nama') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <label class="radio-inline">
                                    <input type="radio" name="jenis_kelamin" id="inlineRadio1" value="L"> L
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="jenis_kelamin" id="inlineRadio2" value="P"> P
                                </label>
